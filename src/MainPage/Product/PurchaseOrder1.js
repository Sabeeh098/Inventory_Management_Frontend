      ...
      <div className="wholeComp">
        ...
        <div className="twoDropdown">
          ...
          <DropdownButton id="dropdown-basic-button" title="FilterBy">
            <Dropdown.Item href="#/action-1" onClick={dailyFnc}>
              Load Number
            </Dropdown.Item>
            <Dropdown.Item href="#/action-2" onClick={dailyFnc}>
              Category
            </Dropdown.Item>
            <Dropdown.Item href="#/action-3" onClick={dailyFnc}>
              Brand
            </Dropdown.Item>
            <Dropdown.Item href="#/action-3" onClick={dailyFnc}>
              sku
          ...
          <div className="inputFilterBY">
            {daily && <input className="inputF" placeholder="enter" />}
          </div>
